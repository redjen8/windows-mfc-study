...
// mfcstudyDoc.cpp: CmfcstudyDoc 클래스의 구현
//
...
CmfcstudyDoc::CmfcstudyDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CmfcstudyDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CmfcstudyDoc::InitializeSearchContent()
{
...
void CmfcstudyDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
